...
from feature_data import Tiny_data
import time
...
class ResNet50(nn.Module):
    def __init__(self, block, layers, num_classes=130):
...
if __name__ == '__main__':
    ...
    for epoch in range(start_epoch, epochs):
        ...
        train_sampler = None
        cls_num_list = [98, 96, 94, 92, 90, 88, 86, 84, 82, 80, 78, 76, 74, 73, 71, 69, 68, 66, 65, 63, 62, 60, 59, 58, 56, 55, 54, 52, 51, 50, 49, 48, 47, 46, 45, 44, 43, 42, 41, 40, 39, 38, 37, 36, 35, 34, 34, 33, 32, 31, 31, 30, 29, 29, 28, 27, 27, 26, 25, 25, 24, 24, 23, 23, 22, 21, 21, 20, 20, 20, 19, 19, 18, 18, 17, 17, 17, 16, 16, 15, 15, 15, 14, 14, 14, 13, 13, 13, 12, 12, 12, 12, 11, 11, 11, 10, 10, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 8, 8, 7, 7, 7, 7, 7, 7, 6, 6, 6, 6, 6, 6, 6, 5, 5, 5, 5, 5, 5, 5, 5]
        ...
        if (epoch + 1) % 100 == 0:
            ...
            torch.save(feature_maps_list, f'Feature_Maps_Resnet50_for_100_{epoch + 1}.pt')
